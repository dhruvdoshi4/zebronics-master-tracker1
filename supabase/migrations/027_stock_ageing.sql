-- Stock ageing report (admin only). Consolidated sheet → Prdcode buckets.
...
create table if not exists public.stock_ageing_snapshot (
  ...
  qty_0_30 numeric(14, 2) not null default 0,
  qty_31_90 numeric(14, 2) not null default 0,
  qty_91_180 numeric(14, 2) not null default 0,
  qty_181_270 numeric(14, 2) not null default 0,
  qty_271_365 numeric(14, 2) not null default 0,
  qty_366_547 numeric(14, 2) not null default 0,
  qty_547_plus numeric(14, 2) not null default 0,
