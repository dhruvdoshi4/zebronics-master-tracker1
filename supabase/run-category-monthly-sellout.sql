...
create policy category_monthly_sellout_read_policy on public.category_monthly_sellout
  for select to authenticated using (true);

drop policy if exists category_monthly_sellout_write_policy on public.category_monthly_sellout;
create policy category_monthly_sellout_write_policy on public.category_monthly_sellout
